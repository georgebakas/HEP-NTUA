...
void trainMVABoosted_bins()
{
  ...
  TFile *sigSrc[1], *sigSrcNorm[1];

  float XSEC_SIGNAL[1] = {16.74};
  float SIG_NORM[1];

  bkgSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Bkg/QCD_HT300to500_TuneCP5_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Bkg/QCD_HT500to700_TuneCP5_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Bkg/QCD_HT700to1000_TuneCP5_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[3] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Bkg/QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[4] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Bkg/QCD_HT1500to2000_TuneCP5_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[5] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Bkg/QCD_HT2000toInf_TuneCP5_13TeV-madgraphMLM-pythia8_Train.root");


  bkgSrcNorm[0] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Bkg/2018/QCD_HT300to500_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[1] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Bkg/2018/QCD_HT500to700_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[2] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Bkg/2018/QCD_HT700to1000_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[3] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Bkg/2018/QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[4] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Bkg/2018/QCD_HT1500to2000_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[5] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Bkg/2018/QCD_HT2000toInf_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  ...
  sigSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2018/Signal/TT_Mtt-1000toInf_TuneCP5_13TeV-powheg-pythia8_Train.root");
  
  //sigSrcNorm[0] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Signal/2018/TT_Mtt-700to1000_TuneCP5_13TeV-powheg-pythia8.root");
  sigSrcNorm[0] = TFile::Open("/eos/cms/store/user/ipapakri/ttbar/MC/Signal/2018/TT_Mtt-1000toInf_TuneCP5_13TeV-powheg-pythia8.root");
