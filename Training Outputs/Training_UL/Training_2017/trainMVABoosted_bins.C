...
void trainMVABoosted_bins()
{
  ...
  bkgSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT300to500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL_Train.root");
  bkgSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT500to700_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL_Train.root");
  bkgSrc[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT700to1000_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL_Train.root");
  bkgSrc[3] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT1000to1500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL_Train.root");
  bkgSrc[4] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT1500to2000_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL_Train.root");
  bkgSrc[5] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT2000toInf_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL_Train.root");

  bkgSrcNorm[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT300to500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL.root");
  bkgSrcNorm[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT500to700_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL.root");
  bkgSrcNorm[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT700to1000_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL.root");
  bkgSrcNorm[3] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT1000to1500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL.root");
  bkgSrcNorm[4] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT1500to2000_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL.root");
  bkgSrcNorm[5] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Bkg/QCD_HT2000toInf_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8_19UL.root");

  sigSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Signal/TTToHadronic_TuneCP5_13TeV-powheg-pythia8_19UL_Train.root");
  sigSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Signal/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_19UL_Train.root");
  sigSrc[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Signal/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_19UL_Train.root");
  
  sigSrcNorm[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Signal/TTToHadronic_TuneCP5_13TeV-powheg-pythia8_19UL.root");
  sigSrcNorm[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Signal/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_19UL.root");
  sigSrcNorm[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2017/Signal/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_19UL.root");
