...
void trainMVABoosted_bins()
{
  ...
  sigSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2018/Signal/TTToHadronic_TuneCP5_13TeV-powheg-pythia8_19UL_Train.root");
  sigSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2018/Signal/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_19UL_Train.root");
  sigSrc[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2018/Signal/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_19UL_Train.root");
  
  sigSrcNorm[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2018/Signal/TTToHadronic_TuneCP5_13TeV-powheg-pythia8_19UL.root");
  sigSrcNorm[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2018/Signal/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_19UL.root");
  sigSrcNorm[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/ul-2018/Signal/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_19UL.root");
