...
void trainMVABoosted_bins()
{
  ...
  float XSEC_SIGNAL[2] = {80.78, 21.43};
  float SIG_NORM[2];
  ...
  sigSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2016/Signal/TT_Mtt-700to1000_TuneCUETP8M2T4_13TeV-powheg-pythia8_Train.root");
  sigSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2016/Signal/TT_Mtt-1000toInf_TuneCUETP8M2T4_13TeV-powheg-pythia8_Train.root");

  sigSrcNorm[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2016/Signal/TT_Mtt-700to1000_TuneCUETP8M2T4_13TeV-powheg-pythia8.root");
  sigSrcNorm[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/mc-2016/Signal/TT_Mtt-1000toInf_TuneCUETP8M2T4_13TeV-powheg-pythia8.root");
