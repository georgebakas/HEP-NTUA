...
void trainMVABoosted_bins()
{
  ...
  bkgSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT300to500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT500to700_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[3] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT1000to1500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[4] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT1500to2000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Train.root");
  bkgSrc[5] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT2000toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Train.root");

  bkgSrcNorm[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT300to500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT500to700_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[2] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[3] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT1000to1500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[4] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT1500to2000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root");
  bkgSrcNorm[5] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/QCD_HT2000toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root");
  ...
  sigSrc[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/TT_Mtt-700to1000_TuneCUETP8M2T4_13TeV-powheg-pythia8_Train.root");
  sigSrc[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/TT_Mtt-1000toInf_TuneCUETP8M2T4_13TeV-powheg-pythia8_Train.root");

  sigSrcNorm[0] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/TT_Mtt-700to1000_TuneCUETP8M2T4_13TeV-powheg-pythia8.root");
  sigSrcNorm[1] = TFile::Open("/eos/cms/store/user/gbakas/ttbar/topTagger/April19/TT_Mtt-1000toInf_TuneCUETP8M2T4_13TeV-powheg-pythia8.root");
