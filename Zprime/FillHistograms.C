...
void FillHistograms(TString file_name, TString mass_name, TString year = "2016")
{
  globalYear = year;
  initFilesMapping();
  cout<<"YEAR: "<<year<<endl;
  ...
  const int mJJbins = 100;
  		...
  		if(ivar<3)
      {
        ...
        std::copy(BND[ivar].begin(), BND[ivar].end(), tempBND);
  		  hParton[ivar] = new TH1F(TString::Format("hParton_%s", varParton[ivar].Data()), TString::Format("hParton_%s",varParton[ivar].Data()), sizeBins, tempBND);
        hReco[ivar] = new TH1F(TString::Format("hReco_%s", varReco[ivar].Data()), TString::Format("hReco_%s",varReco[ivar].Data()), sizeBins, tempBND);
        hParticle[ivar] = new TH1F(TString::Format("hParticle_%s", varParticle[ivar].Data()), TString::Format("hParticle_%s", varParticle[ivar].Data()), sizeBins, tempBND);
      }
      else
      {
        hParton[ivar] = new TH1F(TString::Format("hParton_%s", varParton[ivar].Data()), TString::Format("hParton_%s", varParton[ivar].Data()), mJJbins,1000, 5500 );
        hReco[ivar] = new TH1F(TString::Format("hReco_%s", varReco[ivar].Data()), TString::Format("hReco_%s",varReco[ivar].Data()), mJJbins,1000, 5500 );
        hParticle[ivar] = new TH1F(TString::Format("hParticle_%s", varParticle[ivar].Data()), TString::Format("hParticle_%s",varParticle[ivar].Data()), mJJbins,1000, 5500 );
      }
  ...
  for(int ivar = 0; ivar<NVAR; ivar++)
  {
    hParton[ivar]->Write(TString::Format("hParton_%s", varReco[ivar].Data()));
    hParticle[ivar]->Write(TString::Format("hParticle_%s", varReco[ivar].Data()));
    hReco[ivar]->Write(TString::Format("hReco_%s", varReco[ivar].Data()));
  }//end of ivar
