...
for ifile, file_name in enumerate(glob.iglob('{}/HistoCutFlowJetMassSoftDrop_ZprimeToTT_*.root'.format(year), recursive=True)):
    print('ifile: {} is file: {}'.format(ifile, file_name))
