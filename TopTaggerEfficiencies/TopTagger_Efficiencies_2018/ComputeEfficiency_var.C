...
void ComputeEfficiency_var()
{
  ...
  float mvaCuts[] = {0.1,0.15,0.18,0.2};
  ...
  for(int iCut=0; iCut<4; iCut++)
  {
	  ...
	  { 
		 if(ivar ==0 || ivar ==3)
		 {
		  ...
		  EfficiencyAcceptance(varParton[ivar], varReco[ivar], (ivar+1), NBINS[ivar], tempBND, selMVACut, btagWP,true,deepAK8Wp[4], selOldMva,true); 
			//else EfficiencyAcceptance(varParton[ivar], varReco[ivar], (ivar+1), NBINS[ivar], tempBND, selMVACut, btagWP,false,deepAK8Wp[idAK8], selOldMva,true); 
