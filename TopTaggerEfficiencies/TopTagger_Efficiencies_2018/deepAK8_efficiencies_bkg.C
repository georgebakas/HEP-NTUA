...
void deepAK8_efficiencies_bkg(bool saveTtagger = false, float deepAK8Cut = 0.6, float selMvaCut = 0.3)
{
  initGlobals();
  ...
  TFile *outFile = TFile::Open("deepAK8_efficiencies_bkg.root", "UPDATE");
