void deepAK8_plotSignalOverBackground_jetPt()
{
  ...
  TFile *f = TFile::Open("2018/rootFiles/signal_over_background_jetPt.root");
  ...
  reco_Canvas->cd();
  TH1F* h_reco_tTagger = (TH1F*) f->Get("signal_over_bkg_jetPt_tTagger_0.2");
  ...
  TH1F* h_reco_mva = (TH1F*) f->Get("signal_over_bkg_jetPt_eventMVA_0.8");
