...
//----------------------------------------------------------------------------------------------------------------
	map<TString, TString> filesNom2016 = {{"TTNominal", "TT_TuneCUETP8M2T4_13TeV-powheg-pythia8.root"},
	...
	map<TString, TString> filesNom2017 = {{"TTHadronic_0", "TTToHadronic_TuneCP5_13TeV-powheg-pythia8.root"},
	...
	map<TString, TString> filesNom2018 = {{"TTHadronic_0", "TTToHadronic_TuneCP5_13TeV-powheg-pythia8.root"},
	                               	   {"TTSemiLeptonic_0", "TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8.root"},
	                               	   {"TTTo2L2Nu_0", "TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8.root"}};

	map<TString, float> nominalMCXSEC16 = {{"TTNominal", 832.},
																		 {"TTHadronic_0", 377.96},
	                               	   {"TTSemiLeptonic_0", 365.34},
	                               	   {"TTTo2L2Nu_0", 88.29}};


  map<TString, float> nominalMCXSEC17 = {{"TTHadronic_0", 377.96},
	                               	   {"TTSemiLeptonic_0", 365.34},
	                               	   {"TTTo2L2Nu_0", 88.29}};

  map<TString, float> nominalMCXSEC18 = {{"TTHadronic_0", 377.96},
	                               	   {"TTSemiLeptonic_0", 365.34},
	                               	   {"TTTo2L2Nu_0", 88.29}};

  nominalMCFiles.insert(pair<TString, map<TString, TString>>("2016", filesNom2016));
  nominalMCFiles.insert(pair<TString, map<TString, TString>>("2017", filesNom2017));
  nominalMCFiles.insert(pair<TString, map<TString, TString>>("2018", filesNom2018));

  nominalMCXSEC.insert(pair<TString, map<TString, float>>("2016",nominalMCXSEC16));
  nominalMCXSEC.insert(pair<TString, map<TString, float>>("2017",nominalMCXSEC17));
  nominalMCXSEC.insert(pair<TString, map<TString, float>>("2018",nominalMCXSEC18));
//----------------------------------------------------------------------------------------------------------------
	//data files:
