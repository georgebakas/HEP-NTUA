void deepAK8_plotYields()
{
  ...
  TFile *f = TFile::Open("2017/rootFiles/deepAK8_yields.root");
  ...
  TH1F *sig_tTagger = (TH1F*) f->Get("Yield_Reco_tTagger_0.00");
