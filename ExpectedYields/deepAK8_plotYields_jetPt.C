void deepAK8_plotYields_jetPt()
{

  gStyle->SetOptStat(0);
  TFile *f16 = TFile::Open("2016/rootFiles/deepAK8_yields_jetPt.root");
  TFile *f = TFile::Open("2017/rootFiles/deepAK8_yields_jetPt.root");
  TCanvas *c1 = new TCanvas("c1", "c1", 600, 500);
  
  TH1F *sig_tTagger_16 = (TH1F*)f16->Get("Yield_Reco_jetPt_tTagger_0.20");
  ...
  TH1F *bkg_tTagger_16 = (TH1F*) f16->Get("Bkg_Reco_jetPt_tTagger_0.20");
  ...
  TH1F *sig_tTagger = (TH1F*) f->Get("Yield_Reco_jetPt_tTagger_0.0");
