void deepAK8_plotYieldsJetsMassSoftDrop()
{
  
  gStyle->SetOptStat(0);
  TFile *f16 = TFile::Open("2016/rootFiles/deepAK8_yields_jetMassSoftDrop.root");
  TFile *f = TFile::Open("2017/rootFiles/deepAK8_yields_jetMassSoftDrop.root");
  TCanvas *c1 = new TCanvas("c1", "c1", 600, 500);
  
  TH1F *sig_tTagger_16 = (TH1F*)f16->Get("Sig_yield_jetMassSoftDrop_tTagger_0.20");
  ...
  sig_tTagger_16->SetTitle("Yields jetPt");
  sig_tTagger_16->Draw("P");
  
  TH1F *bkg_tTagger_16 = (TH1F*) f16->Get("Bkg_yield_jetMassSoftDrop_tTagger_0.20");
  ...
  TH1F *sig_tTagger = (TH1F*) f->Get("Sig_yield_jetMassSoftDrop_tTagger_0.00");
  ...
  leg->AddEntry(sig_tTagger, "Signal tTagger '17(0.0)", "lp");
  leg->AddEntry(sig_tTagger_2, "Signal tTagger '17 (0.1)", "lp");
  leg->AddEntry(sig_tTagger_16, "Signal tTagger '16(0.2)", "lp");
  leg->AddEntry(bkg_tTagger, "Bkg tTagger '17(0.0)", "lp");
  leg->AddEntry(bkg_tTagger_2, "Bkg tTagger '17(0.1)", "lp");
