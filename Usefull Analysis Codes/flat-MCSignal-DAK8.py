...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    ...
    #'/store/mc/RunIISummer16MiniAODv3/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/MINIAODSIM/PUMoriond17_backup_94X_mcRun2_asymptotic_v3-v2/20000/7EB827F4-85F1-E811-B6D6-0CC47A7EEF1A.root',
    ...
    #'/store/mc/RunIISummer16MiniAODv3/TT_Mtt-700to1000_TuneCUETP8M2T4_13TeV-powheg-pythia8/MINIAODSIM/PUMoriond17_94X_mcRun2_asymptotic_v3-v2/80000/8C18E299-712D-E911-AAA4-B496910A9088.root'
    #'/store/mc/PhaseISpring17MiniAOD/ZprimeToTT_M-2000_W-200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/FlatPU28to62HcalNZS_90X_upgrade2017_realistic_v20-v1/120000/DA4A2415-0441-E711-A62F-24BE05BD4F81.root '
	
	'/store/mc/RunIISummer17MiniAOD/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/MINIAODSIM/92X_upgrade2017_realistic_v10_ext1-v2/70000/FC11E833-D599-E711-8F91-A4BF0112BDEA.root'
    )
)
...
process.smearedJetsAK8 = cms.EDProducer('JetShiftProducer',
  ...
  payload     = cms.untracked.string('AK8PFPuppi'),
...
##-------------------- User analyzers  --------------------------------
process.boosted = cms.EDAnalyzer('BoostedTTbarFlatTreeProducer_DAK8',
  jets             = cms.InputTag('patJetsReapplyJECAK8'),
  ...
  deepAK8          = cms.string('pfDeepBoostedDiscriminatorsJetTags:TvsQCD'),
  ...
  saveMatchingInfo = cms.untracked.bool(True),
