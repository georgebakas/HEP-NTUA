...
namespace  Rivet {
	...
	void _reconstructspinobservables() {
	    ...
	    // debugging !!! 
	    // const FourMomentum top_lab( 204.46739532 , -6.6399871813 , -53.173330046 , 98.5314603287 );
	    // const FourMomentum tbar_lab( 345.016286577 , 6.6399871809 , 53.173330045 , 296.257538299 );
	    // const FourMomentum lep_lab(  148.93705499 , -7.1074059921 , 49.186063739 , 140.40107643 );
	    // const FourMomentum lbar_lab( 94.554150147 , 42.840475559 , 27.148294946 , 79.80069577 );
	    ...
	    */
	    ...
	    //std::cout<<" ttbar.boostvectr = ("<< ttbar_lab.boostVector().x()  << " , "<< ttbar_lab.boostVector().y() << " , "<< ttbar_lab.boostVector().z() << " ) " << std::endl;
	    ...
	    // std::cout<<" before boosting top_lab = ("<< top_lab.px() << " , "<< top_lab.py() << " , "<< top_lab.pz() << " , "<< top_lab.E() << " ) " << std::endl;
	    // std::cout<<" before boosting tbar_lab = ("<< tbar_lab.px() << " , "<< tbar_lab.py() << " , "<< tbar_lab.pz() << " , "<< tbar_lab.E() << " ) " << std::endl;
	    // std::cout<<" before boosting lep_labr = ("<< lep_lab.px() << " , "<< lep_lab.py() << " , "<< lep_lab.pz() << " , "<< lep_lab.E() << " ) " << std::endl;
	    // std::cout<<" before boosting lbar_lab = ("<< lbar_lab.px() << " , "<< lbar_lab.py() << " , "<< lbar_lab.pz() << " , "<< lbar_lab.E() << " ) " << std::endl;


	    // std::cout<<" after boosting top_ZMFttbar = ("<< top_ZMFttbar.px() << " , "<< top_ZMFttbar.py() << " , "<< top_ZMFttbar.pz() << " , "<< top_ZMFttbar.E() << " ) " << std::endl;
	    // std::cout<<" after boosting tbar_ZMFttbar = ("<< tbar_ZMFttbar.px() << " , "<< tbar_ZMFttbar.py() << " , "<< tbar_ZMFttbar.pz() << " , "<< tbar_ZMFttbar.E() << " ) " << std::endl;
	    // std::cout<<" after boosting lep_ZMFttbar = ("<< lep_ZMFttbar.px() << " , "<< lep_ZMFttbar.py() << " , "<< lep_ZMFttbar.pz() << " , "<< lep_ZMFttbar.E() << " ) " << std::endl;
	    // std::cout<<" after boosting lbar_ZMFttbar = ("<< lbar_ZMFttbar.px() << " , "<< lbar_ZMFttbar.py() << " , "<< lbar_ZMFttbar.pz() << " , "<< lbar_ZMFttbar.E() << " ) " << std::endl;
	    // std::cout<<" after boosting lep_ZMFtbar = ("<< lep_ZMFtbar.px() << " , "<< lep_ZMFtbar.py() << " , "<< lep_ZMFtbar.pz() << " , "<< lep_ZMFtbar.E() << " ) " << std::endl;
	    // std::cout<<" after boosting lbar_ZMFtop = ("<< lbar_ZMFtop.px() << " , "<< lbar_ZMFtop.py() << " , "<< lbar_ZMFtop.pz() << " , "<< lbar_ZMFtop.E() << " ) " << std::endl;
	    ...
	    //agrohsje 
	    //std::cout << " m_coscos is " << _coscos << std::endl;
	    ...
	    //agrohsje 
	    //std::cout<<" m_cosphi is " << _cosphi << std::endl;
