...
def main(width):
    ...
    if width == 1:
        values = {
            2000:[0.235, 0.17, 0.117, 0.08, 0.0568, 0.104],
            2500:[0.132, 0.09, 0.0614, 0.0443, 0.0314, 0.0464],
            3000:[0.0992, 0.0708, 0.0469, 0.033, 0.0244, 0.0462],
            3500:[0.0813, 0.0554, 0.036, 0.0257, 0.0192, 0.0248],
            4000:[0.0749, 0.0488, 0.0318, 0.022, 0.0163, 0.0224]
        }
    elif width == 10:
        values = {
