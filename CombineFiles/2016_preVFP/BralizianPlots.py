...
def plotUpperLimits(file_names, values, width, mass_cut):
    ...
    if width == 1:
        #here you have 1200_12, 1600_16, 1800_18, 2000_20,
        #              2500_25, 3000_30, 3500_35, 4000_40, 4500_45
        cross_section = [1.741e+00, 4.990e-01, 2.839e-01, 1.655e-01,
                        4.667e-02, 1.496e-02, 5.119e-034, 1.902e-03, 7.609e-04]
    elif width ==10:
...
def main(width, mass_cut):
    ...
    if width == 1:
        file_names = ["mZ_1200_12", "mZ_1600_16", "mZ_1800_18", "mZ_2000_20",
    ...
    values = [1200, 1600, 1800, 2000, 2500, 3000, 3500, 4000, 4500]
...
def execute_all_masses(width):
    ...
    values = [1200, 1600, 1800, 2000, 2500, 3000, 4000, 4500];
