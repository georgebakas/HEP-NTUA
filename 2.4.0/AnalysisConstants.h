#ifndef ANALYSISCONSTANTS_H_
#define ANALYSISCONSTANTS_H_
...
namespace AnalysisConstants
{
  ...
  void initConstants()
  {
    ...
    std::map<TString, float> XS2017 = {{"QCD-HT300to500", 322600},
                                       ...
                                       {"ST-t-channel-top-4f", 113.3},
                                       {"ST-t-channel-antitop-4f", 67.91},
                                       {"amcatnlo", 832},
                                       {"madgraph", 832},
                                       {"herwig", 832}};
    ...
    std::map<TString, float> XS2018 = {{"QCD-HT300to500", 323400},
                                       ...
                                       {"ST-tW-top-5f", 34.91},
                                       {"ST-tW-antitop-5f", 34.97},
                                       {"channel-top-4f", 113.3},
                                       {"channel-antitop-4f", 67.91},
    ...
    crossSections.insert(std::pair<TString, std::map<TString, float>>("2016", XS2016));
    ...
    qcdFitInitValues.insert(std::pair<TString, std::map<TString, Double_t>>("2016", qcdFitInitValues2016));
