...
namespace AnalysisConstants_UL
{
  ...
  void initConstants()
  {
    ...
    unfoldingVariables.push_back("leadingJetAbsY");
    unfoldingVariables.push_back("subleadingJetAbsY");
    ...
    unfoldingVariables.push_back("leadingGenPt");
    unfoldingVariables.push_back("subleadingGenPt");
    unfoldingVariables.push_back("yJJGen");
    unfoldingVariables.push_back("ptJJGen");
    unfoldingVariables.push_back("mJJGen");
    unfoldingVariables.push_back("leadingGenAbsY");
    unfoldingVariables.push_back("subleadingGenAbsY");
    ...
    variables.push_back("leadingJetAbsY");
    variables.push_back("subleadingJetAbsY");
    ...
    recoVariables.push_back("leadingJetPt");
    recoVariables.push_back("subleadingJetPt");
    recoVariables.push_back("yJJ");
    recoVariables.push_back("ptJJ");
    recoVariables.push_back("mJJ");
    recoVariables.push_back("leadingJetAbsY");
    recoVariables.push_back("subleadingJetAbsY");
    ...
    partonVariables.push_back("leadingPartonAbsY");
    partonVariables.push_back("subleadingPartonAbsY");
