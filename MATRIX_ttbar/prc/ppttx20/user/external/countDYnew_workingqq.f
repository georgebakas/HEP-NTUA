...
CC
      integer n2,n3,sgnj,sgnk,flgq,flqq
...
C     Include Pqggq
     ...
     &                           +fx1p(-l))*Pqggq(z1)*flgq
       diff2q=diff2q-dlog(xx20)*(fx2p(l)
     &                           +flqq*fx2p(-l))*Pqggq(z2)*flgq
      elseif(l.eq.-j)then
       diff1q=diff1q-dlog(xx10)*(fx1p(l)
     &                           +flqq*fx1p(-l))*Pqggq(z1)*flgq
       diff2q=diff2q-dlog(xx20)*(fx2p(l)*flqq
     &                           +fx2p(-l))*Pqggq(z2)*flgq
      else
...
c    First leg
     ...
     &    +(Deltagggg-D0gggg*D0int(xx10)-D1gggg*D1int(xx10))*fx10(0)
      ...
      tgagag=tgagag+diffg*flqq*flgq*fx20(0)*msqc(0,0)
...
c    Second leg
     ...
     &    +(Deltagggg-D0gggg*D0int(xx20)-D1gggg*D1int(xx20))*fx20(0)
      ...
      tgagag=tgagag+diffg*flqq*flgq*fx10(0)*msqc(0,0)
...
c      sig23=sig23q
     ...
     &                               *flqq
     &     -0.5d0*A1q*(tH1stq+LF*tH1stFq)*flqq
     &     -0.5d0*(B1q-beta0)*sig11q
     &     +0.5d0*B1q*tH1stFq*flqq
     &     -Gamma1q*tH1stFq*flqq
     &     +0.5d0*tgagaq
...
c      sig22=sig22q
     ...
     &                           *flqq
     &     +Gamma1q*(tH1stq+LF*tH1stFq)*flqq
     &     -LF*tgagaq
...
ch
     ...
     &                           *flqq
     &     +Gamma1g*(tH1stg+LF*tH1stFg)*flqq
     &     -LF*tgagag
     &     -B2g*tdeltag*flqq+beta0*tH1stg*flqq
     &     -tcgag-tgamma2g
c     Include missing delta term from C*gamma (no factor 2 here !)
