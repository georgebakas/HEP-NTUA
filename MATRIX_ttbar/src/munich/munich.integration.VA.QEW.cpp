...
void munich::integration_VA_QEW(){
  static Logger logger("munich::integration_VA_QEW");
  ...
  while (osi.int_end == 0){
    ...
    calculate_ME2_VA_QEW(osi);

    /*
    logger << LOG_DEBUG << "V_ME2 = " << setw(15) << setprecision(9) << osi.VA_V_ME2
	   << "   X_ME2 = " << setw(15) << setprecision(9) << osi.VA_X_ME2
	   << "   I_ME2 = " << setw(15) << setprecision(9) << osi.VA_I_ME2
	   << "   b_ME2 = " << setw(15) << setprecision(9) << osi.VA_b_ME2
	   << endl;
    */  
    if (munich_isnan(osi.VA_V_ME2) || munich_isnan(osi.VA_X_ME2) || munich_isnan(osi.VA_I_ME2)){errorhandling_me2(); continue;}
    if (osi.VA_V_ME2 == 0. && osi.VA_X_ME2 == 0. && osi.switch_VI != 2){errorhandling_OL(); continue;}
