...
void munich::integration_CT2_QCD(){
  static Logger logger("munich::integration_CT2_QCD");
  ...
  while (osi.int_end == 0){
    ...
    */
    ...
    ///**///
    calculate_ME2_VT_QCD(osi, generic);
    ///**///    osi.VA_b_ME2 = 1.;
    
    osi.ME2 = osi.VA_b_ME2; // ?????
    ...
    if (osi.switch_old_qT_version){
      ...
      osi.determine_psp_weight_CT2(psi);
    }
    // new version:
    if (!osi.switch_old_qT_version){
      ///**///
      ...
      osi.determine_integrand_CX_ncollinear_CT2(psi);
    ...
    //    osi.output_pdf_comparison_CX_to_CT2(psi);
