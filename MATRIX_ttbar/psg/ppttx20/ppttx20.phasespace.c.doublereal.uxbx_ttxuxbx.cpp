...
void ppttx20_ac_psp_400_uxbx_ttxuxbx(int no_ps, int channel, phasespace_set & psi){
  static Logger logger("ppttx20_ac_psp_400_uxbx_ttxuxbx");
  ...
  else if (channel ==    5){ac_channel_13yv(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   0, psi);}
  else if (channel ==    6){ac_channel_112v(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   5, psi);}
  */
