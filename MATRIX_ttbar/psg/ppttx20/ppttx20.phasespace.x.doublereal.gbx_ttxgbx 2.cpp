...
void ppttx20_ax_psp_400_gbx_ttxgbx(int no_ps, phasespace_set & psi){
  static Logger logger("ppttx20_ax_psp_400_gbx_ttxgbx");
  ...
  psi_container_IS_name.push_back("propagator_5_smin7_smax5");
  ...
  psi_container_IS_name.push_back("propagator_5_smin7_smax7");
