...
void ppttx20_ac_psp_400_gg_ttxddx(int no_ps, int channel, phasespace_set & psi){
  static Logger logger("ppttx20_ac_psp_400_gg_ttxddx");
  ...
  for (int i_p = 0; i_p < psi_c_p[no_ps][channel].size(); i_p++){
    if (psi_c_p[no_ps][channel][i_p] ==   0){
      ...
      psi.c_propagator(no_ps,   0,  44, psi_v_smin[no_ps][  2], psi_v_smax[no_ps][  2], ran + i_p);
    }
  ...
  else if (channel ==    2){ac_channel_1111(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   6,   0, psi);}
  else if (channel ==    3){ac_channel_1111(r, 1, 2, 32, 16, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   6,   0, psi);}
  ...
  else if (channel ==    6){ac_channel_1111(r, 1, 2, 16, 32, 8, 4, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   6,   0, psi);}
  else if (channel ==    7){ac_channel_1111(r, 1, 2, 32, 16, 8, 4, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   6,   0, psi);}
  ...
  else if (channel ==   12){ac_channel_3yv1(r, 1, 2, 32, 4, 8, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   0, psi);}
  ...
  else if (channel ==   21){ac_channel_12v1(r, 1, 2, 32, 4, 8, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   0, psi);}
