...
void ppttx20_ac_psp_400_gbx_ttxgbx(int no_ps, int channel, phasespace_set & psi){
  static Logger logger("ppttx20_ac_psp_400_gbx_ttxgbx");
  ...
  for (int i_p = 0; i_p < psi_c_p[no_ps][channel].size(); i_p++){
    if (psi_c_p[no_ps][channel][i_p] ==   0){
      ...
      psi_v_smax[no_ps][  1] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][40], 2);
      ...
      psi_v_smax[no_ps][  2] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][36], 2);
      ...
      psi_v_smin[no_ps][  3] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][4] + psi_xbsqrts[no_ps][24], 2), psi_smin_opt[no_ps][28]);
      psi_v_smax[no_ps][  3] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][32], 2);
      ...
      psi.c_propagator(no_ps,   0,  28, psi_v_smin[no_ps][  3], psi_v_smax[no_ps][  3], ran + i_p);
    }
    else if (psi_c_p[no_ps][channel][i_p] ==   4){
      psi_v_smin[no_ps][  4] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][32] + psi_xbsqrts[no_ps][12], 2), psi_smin_opt[no_ps][44]);
      ...
      psi.c_propagator(no_ps,   5,  44, psi_v_smin[no_ps][  4], psi_v_smax[no_ps][  4], ran + i_p);
    }
    else if (psi_c_p[no_ps][channel][i_p] ==   5){
      psi_v_smin[no_ps][  5] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][16] + psi_xbsqrts[no_ps][12], 2), psi_smin_opt[no_ps][28]);
      psi_v_smax[no_ps][  3] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][32], 2);
      ...
      psi.c_propagator(no_ps,   0,  28, psi_v_smin[no_ps][  5], psi_v_smax[no_ps][  3], ran + i_p);
    }
    else if (psi_c_p[no_ps][channel][i_p] ==   6){
      psi_v_smin[no_ps][  6] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][8] + psi_xbsqrts[no_ps][20], 2), psi_smin_opt[no_ps][28]);
      psi_v_smax[no_ps][  3] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][32], 2);
      ...
      psi.c_propagator(no_ps,   0,  28, psi_v_smin[no_ps][  6], psi_v_smax[no_ps][  3], ran + i_p);
    }
    else if (psi_c_p[no_ps][channel][i_p] ==   7){
      psi_v_smin[no_ps][  7] = psi_smin_opt[no_ps][48];
      psi_v_smax[no_ps][  5] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][12], 2);
      ...
      psi.c_propagator(no_ps,   5,  48, psi_v_smin[no_ps][  7], psi_v_smax[no_ps][  5], ran + i_p);
    }
      ...
      psi.c_propagator(no_ps,   5,  48, psi_v_smin[no_ps][  7], psi_v_smax[no_ps][  7], ran + i_p);
    }
  }
  ...
  for (int i_f = 0; i_f < psi_c_f[no_ps][channel].size(); i_f++){
    if (psi_c_f[no_ps][channel][i_f] ==   0){
      ...
      psi_v_smin[no_ps][  8] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][32] + psi_xbsqrts[no_ps][24], 2), psi_smin_opt[no_ps][56]);
      ...
      psi.c_timelikeinvariant(no_ps,  56, psi_v_smin[no_ps][  8], psi_v_smax[no_ps][  8], ran + i_f);
    }
    else if (psi_c_f[no_ps][channel][i_f] ==   2){
      psi_v_smin[no_ps][  9] = psi_smin_opt[no_ps][40];
      ...
      psi.c_timelikeinvariant(no_ps,  40, psi_v_smin[no_ps][  9], psi_v_smax[no_ps][  9], ran + i_f);
    }
    else if (psi_c_f[no_ps][channel][i_f] ==   3){
      psi_v_smin[no_ps][ 10] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][16] + psi_xbsqrts[no_ps][40], 2), psi_smin_opt[no_ps][56]);
      psi_v_smax[no_ps][  8] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][4], 2);
      ...
      psi.c_timelikeinvariant(no_ps,  56, psi_v_smin[no_ps][ 10], psi_v_smax[no_ps][  8], ran + i_f);
    }
      ...
      psi.c_timelikeinvariant(no_ps,  44, psi_v_smin[no_ps][  4], psi_v_smax[no_ps][  4], ran + i_f);
    }
      ...
      psi_v_smin[no_ps][ 11] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][32] + psi_xbsqrts[no_ps][20], 2), psi_smin_opt[no_ps][52]);
      psi_v_smax[no_ps][ 10] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][8], 2);
      ...
      psi.c_timelikeinvariant(no_ps,  52, psi_v_smin[no_ps][ 11], psi_v_smax[no_ps][ 10], ran + i_f);
    }
    else if (psi_c_f[no_ps][channel][i_f] ==   8){
      psi_v_smin[no_ps][ 12] = psi_smin_opt[no_ps][36];
      psi_v_smax[no_ps][ 11] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][24], 2);
      ...
      psi.c_timelikeinvariant(no_ps,  36, psi_v_smin[no_ps][ 12], psi_v_smax[no_ps][ 11], ran + i_f);
    }
    else if (psi_c_f[no_ps][channel][i_f] ==   9){
      psi_v_smin[no_ps][ 13] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][16] + psi_xbsqrts[no_ps][36], 2), psi_smin_opt[no_ps][52]);
      psi_v_smax[no_ps][ 10] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][8], 2);
      ...
      psi.c_timelikeinvariant(no_ps,  52, psi_v_smin[no_ps][ 13], psi_v_smax[no_ps][ 10], ran + i_f);
    }
      ...
      psi.c_timelikeinvariant(no_ps,  28, psi_v_smin[no_ps][  5], psi_v_smax[no_ps][  3], ran + i_f);
    }
      ...
      psi.c_timelikeinvariant(no_ps,  28, psi_v_smin[no_ps][  6], psi_v_smax[no_ps][  3], ran + i_f);
    }
      ...
      psi.c_timelikeinvariant(no_ps,  28, psi_v_smin[no_ps][  3], psi_v_smax[no_ps][  3], ran + i_f);
    }
    else if (psi_c_f[no_ps][channel][i_f] ==  13){
      psi_v_smin[no_ps][ 14] = GSL_MAX_DBL(pow(psi_sqrtsmin_opt[no_ps][8] + psi_xbsqrts[no_ps][48], 2), psi_smin_opt[no_ps][56]);
      psi_v_smax[no_ps][  8] = pow(psi_xbsqrts[no_ps][0] - psi_sqrtsmin_opt[no_ps][4], 2);
      ...
      psi.c_timelikeinvariant(no_ps,  56, psi_v_smin[no_ps][ 14], psi_v_smax[no_ps][  8], ran + i_f);
    }
      ...
      psi.c_timelikeinvariant(no_ps,  52, psi_v_smin[no_ps][ 15], psi_v_smax[no_ps][ 10], ran + i_f);
    }
  }
  ...
  for (int i_t = 0; i_t < psi_c_t[no_ps][channel].size(); i_t++){
    if      (psi_c_t[no_ps][channel][i_t] ==   0){
      ...
      psi.c_tchannel_opt(no_ps,   5,  44,   2,  17,  12,  32, ran + 2 * i_t, ran + 2 * i_t + 1);
    }
      ...
      psi.c_tchannel_opt(no_ps,   5,  28,   2,  33,  12,  16, ran + 2 * i_t, ran + 2 * i_t + 1);
    }
      ...
      psi.c_tchannel_opt(no_ps,   5,  60,   1,   2,  48,  12, ran + 2 * i_t, ran + 2 * i_t + 1);
    }
  }
  ...
  else if (channel ==    2){ac_channel_1111(r, 1, 2, 4, 16, 8, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   6, psi);}
  else if (channel ==    3){ac_channel_1111(r, 1, 2, 16, 4, 8, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   6, psi);}
  else if (channel ==    4){ac_channel_1111(r, 1, 2, 8, 4, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   0, psi);}
  else if (channel ==    5){ac_channel_1111(r, 1, 2, 8, 4, 32, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   5,   0, psi);}
  else if (channel ==    6){ac_channel_1111(r, 1, 2, 8, 16, 4, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   6, psi);}
  else if (channel ==    7){ac_channel_1111(r, 1, 2, 16, 8, 4, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   6, psi);}
  else if (channel ==    8){ac_channel_2v11(r, 1, 2, 4, 8, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   0, psi);}
  else if (channel ==    9){ac_channel_2v11(r, 1, 2, 4, 8, 32, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   0, psi);}
  else if (channel ==   10){ac_channel_2v11(r, 1, 2, 4, 16, 8, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   6, psi);}
  else if (channel ==   11){ac_channel_2v11(r, 1, 2, 8, 16, 4, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   6, psi);}
  else if (channel ==   12){ac_channel_3yv1(r, 1, 2, 4, 8, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   0, psi);}
  else if (channel ==   13){ac_channel_3yv1(r, 1, 2, 32, 4, 8, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   5, psi);}
  else if (channel ==   14){ac_channel_3yv1(r, 1, 2, 16, 4, 8, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   0, psi);}
  else if (channel ==   15){ac_channel_3yv1(r, 1, 2, 8, 4, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   0, psi);}
  else if (channel ==   16){ac_channel_4yyv(r, 1, 2, 32, 4, 8, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   5, psi);}
  else if (channel ==   17){ac_channel_4yyv(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   5, psi);}
  else if (channel ==   18){ac_channel_4yyv(r, 1, 2, 32, 16, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   5, psi);}
  else if (channel ==   19){ac_channel_4yyv(r, 1, 2, 32, 8, 4, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   5, psi);}
  else if (channel ==   20){ac_channel_42vv(r, 1, 2, 4, 8, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   5,   0,   5, psi);}
  else if (channel ==   21){ac_channel_12v1(r, 1, 2, 4, 8, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   6,   0, psi);}
  else if (channel ==   22){ac_channel_12v1(r, 1, 2, 32, 4, 8, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   5, psi);}
  else if (channel ==   23){ac_channel_12v1(r, 1, 2, 16, 4, 8, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   0, psi);}
  else if (channel ==   24){ac_channel_12v1(r, 1, 2, 8, 4, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   6,   0, psi);}
  else if (channel ==   25){ac_channel_13yv(r, 1, 2, 32, 4, 8, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   5, psi);}
  else if (channel ==   26){ac_channel_13yv(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   0, psi);}
  else if (channel ==   27){ac_channel_13yv(r, 1, 2, 32, 16, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   5, psi);}
  else if (channel ==   28){ac_channel_13yv(r, 1, 2, 32, 8, 4, 16, p, s, sqrts, smin_opt, sqrtsmin_opt,   6,   0,   5, psi);}
  else if (channel ==   29){ac_channel_112v(r, 1, 2, 4, 8, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   5,   6,   0, psi);}
  else if (channel ==   30){ac_channel_112v(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   0,   5, psi);}
  else if (channel ==   31){ac_channel_112v(r, 1, 2, 32, 16, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   5, psi);}
  else if (channel ==   32){ac_channel_112v(r, 1, 2, 8, 4, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   5,   6,   0, psi);}
  else if (channel ==   33){ac_channel_2v2v(r, 1, 2, 4, 8, 16, 32, p, s, sqrts, smin_opt, sqrtsmin_opt,   5,   0,   0, psi);}
  else if (channel ==   34){ac_channel_2v2v(r, 1, 2, 16, 32, 4, 8, p, s, sqrts, smin_opt, sqrtsmin_opt,   0,   5,   5, psi);}
  */
