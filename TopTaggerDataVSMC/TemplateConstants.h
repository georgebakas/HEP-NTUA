...
//----------------------------------------------------------------------------------------------------------------
	...
	signalStrenth.insert(pair<TString, float>("2016", 0.803012));
	signalStrenth.insert(pair<TString, float>("2017", 0.675417));
	signalStrenth.insert(pair<TString, float>("2018", 0.758664));
