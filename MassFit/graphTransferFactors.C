...
*/
    ...
    tFactorDataError[0] = TMath::Sqrt(TMath::Power(intErrorDataReduced[0]/integralData[0],2) + TMath::Power(integralDataReduced[0]*intErrorData[1]/TMath::Power(integralData[0],2),2) );
	tFactorDataError[1] = TMath::Sqrt(TMath::Power(intErrorDataReduced[1]/integralData[1],2) + TMath::Power(integralDataReduced[0]*intErrorData[1]/TMath::Power(integralData[1],2),2) );
	...
	// rYield = (integralReduced[1] / integral[1]) / (integralReduced[0] / integral[0]);
  	Double_t rYield = tFactorQCD[0] / tFactorQCD[1];
