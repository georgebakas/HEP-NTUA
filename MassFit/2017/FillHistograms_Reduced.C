...
void initFileNames()
{
  ...
  listOfFiles.push_back("WJetsToQQ_HT400to600_qc19_3j_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  listOfFiles.push_back("WJetsToQQ_HT600to800_qc19_3j_TuneCP5_13TeV-madgraphMLM-pythia8.root");
  listOfFiles.push_back("ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
  listOfFiles.push_back("ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root");
...
void FillHistograms_Reduced(int sel = 0)
{
 ...
 for(int f=0; f<listOfFiles.size(); f++)
 {
  ...
  TFile *outFile;
  if(selection ==0)
    outFile = new TFile("Histo_JetHT_Run2017-31Mar2018_New_100_reduced.root", "UPDATE");
  if(selection ==1)
    outFile = new TFile("Histo_TT_Mtt-700toInf_TuneCP5_13TeV-powheg-pythia8_New_100_reduced.root", "UPDATE");
  if(selection ==2)
    outFile = new TFile("Histo_QCD_HT300toInf_TuneCP5_13TeV-madgraphMLM-pythia8_New_100_reduced.root", "UPDATE");
  if(selection ==3)
    outFile = new TFile("Histo_SubdominantBkgs_New_100_reduced.root", "UPDATE");
