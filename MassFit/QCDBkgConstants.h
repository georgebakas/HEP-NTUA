...
//----------------------------------------------------------------------------------------------------------------
  ...
  std::map<TString, Double_t> qcdFitInitValues2016 = {{"qcd_b0", 3.0981e-01},
                                                        {"qcd_b1", 9.0739e-01},
                                                        {"qcd_b2", 2.1589e-07},
                                                        {"qcd_b3", 2.2265e-03},
                                                        {"qcd_b4", 4.2621e-03},
    ...
    std::map<TString, Double_t> qcdFitInitValues2017 = {{"qcd_b0", 3.0981e-01},
                                                        {"qcd_b1", 1.9814e+00},
                                                        {"qcd_b2", 8.7545e-02},
                                                        {"qcd_b3", 2.2265e-03},
                                                        {"qcd_b4", 3.0788e-02},
    ...
    std::map<TString, Double_t> qcdFitInitValues2018 = {{"qcd_b0", 2.7840e-01},
                                                        {"qcd_b1", 5.6995e-01},
                                                        {"qcd_b2", 4.6676e-02},
                                                        {"qcd_b3", 1.5639e-03},
                                                        {"qcd_b4", 5.8243e-03},
	...
	qcdParams.insert(pair<TString, map<TString, Double_t>>("2016_preVFP",qcdFitInitValues2016));
  qcdParams.insert(pair<TString, map<TString, Double_t>>("2016_postVFP",qcdFitInitValues2016));
	qcdParams.insert(pair<TString, map<TString, Double_t>>("2017",qcdFitInitValues2017));
	qcdParams.insert(pair<TString, map<TString, Double_t>>("2018",qcdFitInitValues2018));
