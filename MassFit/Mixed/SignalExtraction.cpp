...
void SignalExtractionSpecific(TString year = "2016", TString variable = "jetPt0")
{
    ...
    TFile *infDataMedium = TFile::Open(TString::Format("%s/Histo_Data_%s_100_reduced.root", year.Data(), year.Data()));
    TFile *infDataLoose = TFile::Open(TString::Format("%s/Histo_Data_%s_100_reduced_Loose.root", year.Data(), year.Data()));
    ...
    */
    ...
    TFile *outf;
    outf = new TFile(TString::Format("%s/FiducialMeasurement/EqualBinning/%s/SignalHistograms.root",year.Data(),method.Data()), "");
