...
TString eosPath;
int selection;
//float deepCSVFloat = 0.4184; //medium wp
float deepCSVFloat = 0.1241; //loose wp
...
void initXsections()
{
  ...
  XSEC.push_back(71.74); //ST_t-channel_antitop_5f
  XSEC.push_back(119.7); //ST_t-channel_top_5f
  }
  else if(selection ==5)
  {
...
void initHistoNames()
{
  ...
  else
  {
    ...
    histoNames.push_back("ST_t-channel_antitoptop_5f");
    histoNames.push_back("ST_t-channel_top_5f");
  }
  else if (selection ==5)
  {
    histoNames.push_back("QCD_bEnriched_histo_200_300");
    histoNames.push_back("QCD_bEnriched_histo_300_500");
    histoNames.push_back("QCD_bEnriched_histo_500_700");
    histoNames.push_back("QCD_bEnriched_histo_700_1000");
    histoNames.push_back("QCD_bEnriched_histo_1000_1500");
    histoNames.push_back("QCD_bEnriched_histo_1500_2000");
    histoNames.push_back("QCD_bEnriched_histo_2000_Inf");
  }
}
void initGlobals()
{
...
void FillHistograms_Reduced(int sel = 0)
{
 ...
 for(int f=0; f<listOfFiles.size(); f++)
 {
  ...
  TFile *outFile;
  if(selection ==0)
    outFile = new TFile("Histo_Data_2018_Loose_100_reduced.root", "RECREATE");
  if(selection ==1)
  ...
  if(selection ==5)
    outFile = new TFile("Histo_QCD_bEnriched_HT200toInf_100_reduced.root", "RECREATE");
