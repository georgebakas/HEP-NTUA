...
void initFilesMapping()
{
	...
	deepCSVWP.insert(pair<TString, float>("2016_Loose", 0.2217));
	deepCSVWP.insert(pair<TString, float>("2017_Loose", 0.1522));
	deepCSVWP.insert(pair<TString, float>("2018_Loose", 0.1241));
