...
void plot_QCDClosure_afterFit(TString year = "2016", TString recoVar = "jetPt0")
{
  initFilesMapping();
  //TT file 
  TFile *infTT = TFile::Open(filesSignal[year.Data()]);  
  //TFile *infTT = TFile::Open("SignalOutput_AllRegions_0.00_CSVv2.root");  
  //QCD file
  TFile *infBkg = TFile::Open(filesBkg[year.Data()]);
